...
## 7. (권장) iOS Notification Service Extension(리치 푸시) 설정

<Info> `notifly-sdk` 버전 3.0.4 이상부터 지원됩니다. </Info>

Notification Service Extension을 설정하면 리치 푸시(Rich Push) 기능을 사용할 수 있습니다. [리치 푸시 알림](/advanced/rich-push-notification)를 참고해 설정하세요.
